	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 164,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: 'images/progressbg_green.gif'
				height			: 18,											// Height of the progressbar - don't forget to adjust your image too!!!
