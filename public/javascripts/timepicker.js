...
Timepicker.prototype = {
    init: function()
    {
        ...
        this._colonPos  = -1;
        this._visible   = false;
        this.tpDiv      = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all ui-helper-hidden-accessible" style="width: 100px; display: none; position: absolute; background-color:#666; border:1px solid black"></div>');
        this._generateHtml();
    },
