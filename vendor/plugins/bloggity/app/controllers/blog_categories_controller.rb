class BlogCategoriesController < ApplicationController
  ...
  def new
    raise "Hello, #{current_user.andand.name || 'User'}:\r\nYou cannot make categories.  Get off our lawn."
  ...
  def edit
    raise "Hello, #{current_user.andand.name || 'User'}:\r\nYou cannot change categories.  Get off our lawn."
  end
  ...
  def create
    ...
    raise "Hello, #{current_user.andand.name || 'User'}:\r\nYou cannot create categories.  Get off our lawn."
    respond_to do |format|
  ...
  def update
    raise "Hello, #{current_user.andand.name || 'User'}:\r\nYou cannot update categories.  Get off our lawn."
    respond_to do |format|
